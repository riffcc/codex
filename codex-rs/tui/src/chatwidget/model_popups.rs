...
impl ChatWidget {
    ...
    pub(crate) fn open_all_models_popup(&mut self, presets: Vec<ModelPreset>) {
        ...
        for preset in presets.into_iter() {
            ...
            let does_not_need_effort_picker = preset.supported_reasoning_efforts.len() <= 1;
            ...
            items.push(SelectionItem {
                ...
                is_default: preset.is_default,
                actions,
                dismiss_on_select: does_not_need_effort_picker,
                dismiss_parent_on_child_accept: !does_not_need_effort_picker,
                ..Default::default()
            });
        }
